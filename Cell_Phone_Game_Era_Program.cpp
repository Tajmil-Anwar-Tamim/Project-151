...
#define Border_Sign          if(Snake_Marker==1 || Snake_Marker==2) cout<<". ";                             else cout<<char(219);
#define Multiple_Border_Sign if(Marker==2) for(int i=0;i<21;i++) cout<<char(219); else if(Snake_Marker==1 || Snake_Marker==2) for(int i=0;i< Snake_Area_Column + 1; i++) Border_Sign       else for(int i=0;i<2*Snake_Area_Column +1;i++) Border_Sign
...
//            else if (KEY=='g' && is_Continuous_Change_Color==true) is_Continuous_Change_Color= false;
    ...
    switch (Marker){
        ...
        case 1:     //SNAKE
          ...
          Snake_Menu:
            ...
            Multi_Tabs_2 printf(" Press 8,   to                  Customize Snake Area\n");
            Multi_Tabs_2 printf(" Press 9,   to                      see Instructions\n\n");
            Multi_Tabs_2 printf(" Press 0,   to                       Go to Main Menu\n");
            ...
            while(true)
            {
                ...
                if (kbhit())           //Control by arrow KEY
                {
                    ...
                    if (Snake_Marker >= 1 && Snake_Marker <= 4  ) break;
    ...
    //            Delay = 450-50*Level; //Speed
                ...
                while(1)
                {
                    ...
                    int Snake_Head= ( Snake_Area_Row /2)* Snake_Area_Column  +  Snake_Area_Column /2 +1, Snake_Body[ Snake_Area_Row * Snake_Area_Column +5] = {0}; //0,1-100,Primary body Size(5)+Extra some for avoid silly risk
                    char Move='6';
                    char PlayGround[ Snake_Area_Row * Snake_Area_Column +6]; //0,1-100,NULL+Primary body Size(5)+Extra some for avoid silly risk
                    temp++;
                    ...
                    while(1)
                    {
                        ...
                        while(1)                  //jate fruit snake er body borabor na ase
                        {
                            ...
                            if((is_Fruit_in_Blank_Space == false || Fruit == Snake_Head) && Change <= 2* Snake_Area_Row * Snake_Area_Column  ) //Chnge variable ta NewLinear karon holo jodi snake body r size full arear soman hoy orthat fruit dewar moto kono jayga na thake tahole snake body borabor porbe , eta na dile oi muhurte program continiously choltei thakto, susthu vabe game complete hoto na
                            {
                                ...
                                Fruit++;
                                Fruit = 1+Fruit %  Snake_Area_Row * Snake_Area_Column ; //jate 100 overtek na kore
                            }
                        ...
                        while(1)                  //jate fruit snake er body borabor na ase
                        {
                            ...
                            if((is_Fruit_in_Blank_Space == false || Bonus == Snake_Head) && Change <= 2* Snake_Area_Row * Snake_Area_Column  ) //Chnge variable ta NewLinear karon holo jodi snake body r size full arear soman hoy orthat fruit dewar moto kono jayga na thake tahole snake body borabor porbe , eta na dile oi muhurte program continiously choltei thakto, susthu vabe game complete hoto na
                            {
                                is_Fruit_in_Blank_Space = true;
                                Bonus++;
                                Bonus = 1+Bonus % Snake_Area_Row * Snake_Area_Column ; //jate row*col overtek na kore
                            }
                        ...
                        for(i = 1; i <=  Snake_Area_Row * Snake_Area_Column ; i++)
                        {
                           /** changeTextColour(); */
                           ...
                           if(i% Snake_Area_Column  == 0) {Border_Sign;  NewLine;  Multi_Tabs_1;  Border_Sign;  }
                        }
                        ...
                        if(Snake_Marker==1 || Snake_Marker==2) if(Finish) break; //snake nijeke bite korle game over
                        if(Snake_Marker==3 || Snake_Marker==4) if(Snake_Head >  Snake_Area_Row * Snake_Area_Column  || Snake_Head<= 0 || Finish ) break;
    ...
    //                     Delay = 450-50*Level; ///Speed  ///You can off it
                        ...
                        if(Snake_Marker==1 || Snake_Marker==2)
                        {
                            //to move to up / down / left / right (below) - (According to KEY-board Numarical Pads)
                            if(Move == '6') {Snake_Head++;     /** to move Right */  if(Snake_Head% Snake_Area_Column  == 1) Snake_Head -=  Snake_Area_Column ; /**Dan dike ber hoye gele oi borabor Bam dik diye asbe */ }
                            if(Move == '4') {Snake_Head--;     /** to move Down  */  if(Snake_Head% Snake_Area_Column  == 0) Snake_Head +=  Snake_Area_Column ; /**Bam dike ber hoye gele oi borabor Dan dik diye asbe */}
                        ...
                        {
                            if(Move== '6') {Snake_Head++;      if(Snake_Head% Snake_Area_Column == 1)  { Snake_Head= 0; continue; }}      //Box e touch lagle Game over
                            if(Move== '4') {Snake_Head--;      if(Snake_Head% Snake_Area_Column == 0)  { Snake_Head= 0; continue; }}      // " " "
                        ...
                        if(Snake_Head == Fruit)         //Snake Fruit eat korar sathe sathe -
                        {
                            ...
                            FruitCount++;
                            Sound
                            if(Score%5==0 && Score!=0) {BonusFlag=true; Tempo= 0; Bonus = Snake_Fruit_position_Declaration_Function (Call); Sound;}                     //-Sound hobe
                            Fruit =  Snake_Fruit_position_Declaration_Function (Call);     // -fruit er possition change hobe
                        }

                        Tempo++;
                        if(Tempo>5+ Snake_Area_Row + Snake_Area_Column ) {Bonus=0; BonusFlag=false;}

                        if(Snake_Head == Bonus)         //Snake Bonus eat korar sathe sathe -
                        {
                            Sound
                            Point += 2*((10+Snake_Area_Row+ Snake_Area_Column )-Tempo);
                            Bonus=0;
                            BonusFlag=false;
                            BonusCount++;
                        }
                    ...
                    if (Score < Snake_Area_Row * Snake_Area_Column -3) {NewLine Multi_Tabs_1 cout<<"\tGame Over!"<<endl;  NewLine}

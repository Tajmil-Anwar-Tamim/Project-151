...
// ─── Linux: conio.h + windows.h replacement ──────────────────────
int kbhit() {
...
#define Border_Sign          if(Marker==2) cout<<"O"; else if(Snake_Marker==1 || Snake_Marker==2 || Snake_Marker==5 || Snake_Marker==6 || Snake_Marker==9) cout<<". ";                             else cout<<"X";
#define Multiple_Border_Sign if(Marker==2) for(int i=0;i<21;i++) cout<<"O"; else if(Snake_Marker==1 || Snake_Marker==2 || Snake_Marker==5 || Snake_Marker==6 || Snake_Marker==9) for(int i=0;i< Snake_Area_Column + 1; i++) Border_Sign       else for(int i=0;i<2*Snake_Area_Column +1;i++) Border_Sign
...
Select Snake Game Type & Select Level Then Play the Game. You can customize Snake Area Size. You can Also Change Snake Style & Color. You can Also see the Playing of AI.\n\nIn Playing Time : \n";
     ...
     Multi_Tabs_1 cout<<"Move Snake   : W,A,S,D"<<endl;
     Multi_Tabs_1 cout<<"Pause        : Space"<<endl;
...
{
    if(KEY=='+' ) {Time_Delay++; Sound if(Time_Delay>100) Time_Delay=91; if(Time_Delay>10) Time_Delay+=9; }
    if(KEY=='-' ) {Time_Delay--; Sound if(Time_Delay<0)   Time_Delay=0;  if(Time_Delay>10) Time_Delay-=9; }
    ...
    if (KEY=='^')  {TabNumber=0;                                          if((Marker==1 || Marker==2) && is_Playing == true) clearScreen();}
...
char Dicission_in_Snake_And_Pac_Game  (char a)
{
    ...
    Multi_Tabs_3 cout << "To Play Again in Different Speed :  Press --> <'Z'> \n";
    Multi_Tabs_3 cout << "To Goto Local Menu :  Press --> <'H'>\n";
    Multi_Tabs_3 cout << "To Goto Main  Menu :  Press --> <'Q'>\n";
...
{
    NewLine
    Multi_Tabs_4 cout << "To Play Again in  'Different Team' & 'Different Over-Wicket' :\nPress --> '1'\n";
    Multi_Tabs_4 cout << "To Play Again in  ' Same Team'     & 'Different Over-Wicket' :\nPress --> '2'\n";
    Multi_Tabs_4 cout << "To Play Again in  ' Same Team'     & ' Same Over-Wicket'   with   Tossing :\nPress --> '3'\n";
    Multi_Tabs_4 cout << "To Play Again in  ' Same Team'     & ' Same Over-Wicket'  without Tossing :\nPress --> '4'\n";
    ...
    while(true)
    {
        ...
        if (kbhit())           //Control by arrow KEY
        {
            ...
            if    (KEY== '1' || KEY=='!' )               {a= '1';   break;}
            if    (KEY== '2' || KEY=='@' )               {a= '2';   break;}
            if    (KEY== '3' || KEY=='#' )               {a= '3';   break;}
            if    (KEY== '4' || KEY=='$' )               {a= '4';   break;}
...
void Show_Main_Menu()
{
    ...
    if(KEY!='w' && KEY!='s') clearScreen(); //All Previous Print Erased
    else                   gotoxy(0,0);

    if(is_Premium) Markered_Symbol = char(251);
    else           Markered_Symbol = '*';
    ...
    Multi_Tabs_3 if(Marker==1) cout<<Markered_Symbol; else cout<<char(32); printf("Press 1 : SNAKE  ERA \n");
    Multi_Tabs_3 if(Marker==2) cout<<Markered_Symbol; else cout<<char(32); printf("Press 2 : PACMAN ERA \n\n");

    Multi_Tabs_3 if(Marker==3) cout<<Markered_Symbol; else cout<<char(32); printf("Press 3 : TIC TAC TOE ERA (MAN VS COM)\n");
    Multi_Tabs_3 if(Marker==4) cout<<Markered_Symbol; else cout<<char(32); printf("Press 4 : TIC TAC TOE ERA (MAN VS MAN)\n\n");

    Multi_Tabs_3 if(Marker==5) cout<<Markered_Symbol; else cout<<char(32); printf("Press 5 : SNAKE-LADDER-LUDO ERA\n");
    Multi_Tabs_3 if(Marker==6) cout<<Markered_Symbol; else cout<<char(32); printf("Press 6 : SUDOKU ERA\n\n");

    Multi_Tabs_3 if(Marker==7) cout<<Markered_Symbol; else cout<<char(32); printf("Press 7 : CRICKET ERA\n");
    Multi_Tabs_3 if(Marker==8) cout<<Markered_Symbol; else cout<<char(32); printf("Press 8 : Mini GAMES ERA\n\n");

//    Multi_Tabs_3                                           cout<<char(32); printf(" Press (' \" ] } ), to Change Text & BG Colour\n");                //Instruction end
    Multi_Tabs_3                                           cout<<char(32); printf("Press ?: More Instruction\n");
  ...
  Menu:
    ...
    while(true)
    {
        ...
        if (kbhit())           //Control by arrow KEY
        {
            ...
            else if (KEY=='x' || KEY=='X' || KEY=='Q'  ) {Marker=100; break;}

            else if (KEY=='s'  || KEY == 'S'  ) { Marker++; if(Marker>8) Marker=1; goto Menu; }
            else if (KEY=='w' || KEY=='W' ) { Marker--; if(Marker<1) Marker=8; goto Menu; }
            ...
            else if (KEY=='^')  {TabNumber=0; goto Menu;}
    ...
    switch (Marker){
        ...
        case 1:     //SNAKE
          ...
          Snake_Menu:
            ...
            Multi_Tabs_3 printf(" Press --> 1: CLASSIC SNAKE GAME\n");
            Multi_Tabs_3 printf(" Press --> 2: NO-END  CLASSIC SNAKE GAME\n");
            Multi_Tabs_3 printf(" Press --> 3: BOX SNAKE GAME\n");
            Multi_Tabs_3 printf(" Press --> 4: NO-SELF-HIT BOX SNAKE GAME\n\n");

            Multi_Tabs_3 printf(" Press --> 5: AI CLASSIC SNAKE GAME\n");
            Multi_Tabs_3 printf(" Press --> 6: NO-END  AI CLASSIC SNAKE GAME\n");
            Multi_Tabs_3 printf(" Press --> 7: AI BOX SNAKE GAME\n");
            Multi_Tabs_3 printf(" Press --> 8: NO-SELF-HIT AI BOX SNAKE GAME \n\n");

            Multi_Tabs_3 printf(" Press --> 9: SAFE-MOVE AI CLASSIC SNAKE GAME\n");
            Multi_Tabs_3 printf(" Press --> 0: SAFE-MOVE AI BOX SNAKE GAME\n\n");

            Multi_Tabs_3 printf(" Press --> S: to Customize Snake Area\n");
            Multi_Tabs_3 printf(" Press --> ?: Instructions\n\n");
            ...
            while(true)
            {
                ...
                if (kbhit())           //Control by arrow KEY
                {
                    ...
                    if (KEY=='x' || KEY=='X' || KEY=='a' || KEY=='A' || KEY=='H'  || KEY=='Q'  )     goto Menu;
            ...
            while(true)
            {
                ...
                if(Snake_Marker==2)
                {
                    ...
                    cout<<"#Instruction : Here your target is eat more Fruit to Increase Score. The Snake's Size is increasing according to eat Fruit. To Close the game Press - 'x' or ''Q'' Key. You should Control the Snake by using Arrow KEY\n\n";
                }
                ...
                while(1)
                {
                    ...
                    while(1)
                    {
                        ...
                        Multiple_Border_Sign NewLine NewLine
                                             ...
                                             NewLine
                                             Multi_Tabs_1 cout<<" Instructions : Press Slash Key "<<endl;
                        ...
                        if (kbhit())           //Control by arrow KEY
                        {
                            ...
                            // Check for arrow KEY input
                                if(KEY=='w' || KEY=='W' || KEY=='8'  ) // Up arrow
                                    Move='8';

                                else if(KEY=='s'  || KEY == 'S'  || KEY=='2' )// Down arrow
                                    Move='2';

                                else if(KEY=='a' || KEY=='A' || KEY=='4' ) // Left arrow
                                    Move='4';

                                else if(KEY=='d' || KEY=='D' || KEY=='6' ) // Right arrow
                                    Move='6';
                        ...
                        if(Snake_Marker==0)
                        {
                         ...
                         if(Level==2) Delay=750;
                         if(Level==3) Delay=500;
                         if(Level==4) Delay=300;
                         if(Level==5) Delay=200;
     ...
     case 2:
          ...
          PacMan_Menu:
            ...
            Multi_Tabs_3 printf(" Press --> 1 :  PACMAN in EASY MODE\n");
            Multi_Tabs_3 printf(" Press --> 2 :  PACMAN in HARD MODE\n\n");

//            Multi_Tabs_3 printf(" Press --> 8 : to Customize PacMan Area\n");
            Multi_Tabs_3 printf(" Press --> 9 : Instructions\n");
            ...
            while(true)
            {
                ...
                if (kbhit())           //Control by arrow KEY
                {
                    ...
                    if (KEY=='x' || KEY=='a' || KEY=='A' || KEY=='0')  goto Menu;
            ...
            while(true)
            {
                ...
                while(true)
                {
                    ...
                    if (kbhit())           //Control by arrow KEY
                    {
                        ...
                        if    (KEY>='1' && KEY<='8') {Level= KEY-'0'; break;}
                        if    (KEY=='x' || KEY=='a' || KEY=='A')  goto Menu;
                ...
                pac_start:    ///if Pacman Lost his a Life then Program Start from here
                    ...
                    while(true)                                        ///Protibar Move korar por Program ekhane chole asbe
                    {
                        ...
                        if (kbhit())
                        {
                            ...
                            // Check for arrow KEY input
                            if(KEY=='w' || KEY=='W' || KEY=='8' )        Move='8';
                            else if(KEY=='s'  || KEY == 'S'  || KEY=='2' )   Move='2';
            ...
            while(1)
            {
                ...
                while(true)
                {
                    ...
                    if (kbhit())           //Control by arrow KEY
                    {
                        ...
                        if    (KEY == 'x' || KEY == 'a' || KEY=='A'  || KEY=='H'  || KEY=='Q' ) break;

                    }
                }

                if(KEY=='x' || KEY == 'a' || KEY=='A'  || KEY=='H'  || KEY=='Q'  ) goto Menu;
                ...
                while(true)
                {
                    ...
                    if (kbhit())           //Control by arrow KEY
                    {
                        ...
                        if    (KEY=='I' || KEY=='C' || KEY == 'T' ) {who=KEY; break;}
                        if    (KEY=='a' || KEY=='A' || KEY == 77 || KEY == 'x' ) break;
                        if    (KEY=='H'  || KEY=='Q'  || KEY=='X') goto Menu;
                    }
                }
            ...
            while(1)
            {
                ...
                while(true)
                {
                    if (kbhit())           //Control by arrow KEY
                    {
                        ...
                        if    (KEY=='1' || KEY=='2' || KEY == '0' || KEY=='x' || KEY == 'a' || KEY=='A'   ) { break;}
...
//                                    NewLine cout << "Already Exist\n\n";
        ...
        case 5: //Ludo Snake-Ladder (vs Computer)
            ...
            Multi_Tabs_3 printf(" Press --> 1 : MAN VS COMPUTER\n");
            Multi_Tabs_3 printf(" Press --> 2 : MULTIPLE PLAYER\n\n");
            Multi_Tabs_3 printf(" Press --> 9 : Instructions\n");
            Multi_Tabs_3 printf(" Press --> 0 : to Go to Main Menu\n");
            ...
            while(true)
            {
                ...
                if (kbhit())           //Control by arrow KEY
                {
                    ...
                    if(Ludo_Marker == 9)
                    {
                             ...
                             _getch(); goto Snake_Ladder_Ludo_Menu;
                    }
            ...
            if(Ludo_Marker==1)
            {
                while(true)
                {
                    ...
                    NewLine Multi_Tabs_3 cout << " Press -->  'H'/'Q'/X KEY to CLOSE The GAME \n\n";
                    ...
                    {
                        KEY = _getch();
                        if (KEY=='x' || KEY=='X' || KEY=='H'  || KEY=='Q' ) goto Menu;
                ...
                while(true)
                {
                    ...
                    while(true)
                    {
                        ...
                        if (kbhit())           //Control by arrow KEY
                        {
                            ...
                            if    (KEY=='w' || KEY=='W')  {row--;break;}
                            if    (KEY=='s'  || KEY=='S' )  {row++;break;}
                            if    (KEY=='a' || KEY=='A')  {col--;break;}
                            if    (KEY=='d' || KEY=='D')  {col++;break;}
                            if    (KEY>='0' && KEY<='9') {Value= KEY-'0'; break;}
                            if    (KEY=='X') goto Menu;
                            if    (KEY=='H'  || KEY=='Q' ) goto Menu;
...
//                    cout<<"#Instruction : Here You should Fill Up All of the Blank Space Properly (According to Sudoku Rules).\n\n Here ('*' Sign Before Number) Indicates Current Index, ('`' sign After Number) indicates Your Filled Index. To Change Index Possition Press <Arrow Keys: Left/Right/Up/Down>, To insert value into the Index: Select Index Possition, then input the value < From 1 to 9>. If You want to Remove Inputed Value Press '0'. You can't change the Given Value. If you fill up all the blank space properly, then the level will be completed & You get Congratulation. Otherwise Game will be Running. But if you want to close the program : Press <Capital 'X' or 'Q' KEY or 'H' KEY> \n\n";
                ...
                _getch(); Multi_Tabs_1 cout << " Again Congratulation!\n";
                _getch(); Multi_Tabs_1 cout << "  Further Congratulation!\n"; // 3 time Congratulation (not so necessary)
                _getch(); Multi_Tabs_1; cout<<"Many Many Congratulatipon!\n";
                            ...
                            while(1)
                            {
                                ...
                                while(true)
                                {
                                    ...
                                    if (kbhit())           //Control by arrow KEY
                                    {
                                        ...
                                        if    (KEY=='x' || KEY=='X' || KEY=='H'  || KEY=='Q' )  {is_Team_named = false; is_over_Wick_Selected = false; is_Tossing = false; goto Menu;}
                                        if    (KEY=='d' || KEY=='D' || KEY==' ')                         {KEY=rand()%7 +'0';   break;}
                    ...
                    case 1:
                        while(1)
                        {
                            ...
                            NewLine NewLine Multi_Tabs_2 cout<<"TO SHOT BULLET : Press --> ANY KEY\n";
                                            Multi_Tabs_2 cout<<"TO Close the Game : Press --> <'H'/'Q'/X> KEY\n\n";
...
//                                cout<<"Press --> 'H' or 'T' (without quatation):";
                                while(true)
                                {
                                    ...
                                    if (kbhit())           //Control by arrow KEY
                                    {
                                        ...
                                        if(KEY=='h' || KEY == 't' || KEY == 'x' || KEY=='a' || KEY=='A') break;
                                        if(KEY=='H' || KEY == 'T' || KEY == 'X' || KEY=='d' || KEY=='D') break;
...
//                                cout<<"\nPress --> 'R' or 'P' or 'Z' (without quatation):";
                                while(true)
                                {
                                    ...
                                    if (kbhit())           //Control by arrow KEY
                                    {
                                        ...
                                        if(KEY=='r' || KEY == 'p' || KEY == 's' || KEY == 'x' || KEY=='a' || KEY=='A') break;
                                        if(KEY=='R' || KEY == 'P' || KEY == 'S' || KEY == 'X' || KEY=='d' || KEY=='D') break;

                                    }
                                }

                                if(KEY=='a' || KEY=='A') goto Menu;

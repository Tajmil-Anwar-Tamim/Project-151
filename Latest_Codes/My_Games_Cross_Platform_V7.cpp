...
void Instruction()
{
    ...
    cout<< "Press -->       Up/Down       Arrow Keys  : to Select the Game on Menu [If you are on the Menu]       \n";
    cout<< "Press -->      Enter/ Right_Arrow Key     : to Entered into the Selected Game on Menu [if you are on the Menu] \n\n";
...
void Snake_Instruction()
{
    ...
    Multi_Tabs_1 cout<<"To Change Snake Style -> Press < Small u/i/o/p Keys >"<<endl;
...
{
    NewLine
     cout << "To Play Again in  'Different Team'    &   'Different Over-Wicket'                         :  Press --> 'q'\n";
     cout << "To Play Again in  '   Same   Team'    &   'Different Over-Wicket'                         :  Press --> 'w'\n";
     cout << "To Play Again in  '   Same   Team'    &   '   Same   Over-Wicket'   with     Tossing      :  Press --> 'e'\n";
     cout << "To Play Again in  '   Same   Team'    &   '   Same   Over-Wicket'  without   Tossing      :  Press --> 'r'\n";

     cout << "To Goto Main Menu                                                                         :  Press --> 'x'\n";
...
void Print_Ludo(int *Board,int n, int Dice, int k)
{
    hideCursor();
    clearScreen();
    Multi_Tabs_1 cout << " LUDU SNAKE-LADDER GAME\n\n";
    Multi_Tabs_1 cout << "     [MULTI-PLAYER]    \n\n\n";

    Multi_Tabs_4 cout<<"Snakes  : 97 --> 12, 63 -->  3, 70 --> 25, 32 --> 13, 60 --> 38, 73 --> 47, 82 --> 43 \n";
...
void Show_Main_Menu()
{
    ...
    Multi_Tabs_3 if(Marker==1) cout<<Markered_Symbol; else cout<<" "; printf(" Press   1  :   to Enter                    SNAKE  ERA \n");
    Multi_Tabs_3 if(Marker==2) cout<<Markered_Symbol; else cout<<" "; printf(" Press   2  :   to Enter                    PACMAN ERA \n\n");

    Multi_Tabs_3 if(Marker==3) cout<<Markered_Symbol; else cout<<" "; printf(" Press   3  :   to Enter   TIC TAC TOE ERA (MAN VS COM)\n");
    Multi_Tabs_3 if(Marker==4) cout<<Markered_Symbol; else cout<<" "; printf(" Press   4  :   to Enter   TIC TAC TOE ERA (MAN VS MAN)\n\n");

    Multi_Tabs_3 if(Marker==5) cout<<Markered_Symbol; else cout<<" "; printf(" Press   5  :   to Enter          SNAKE-LADDER-LUDO ERA\n");
    Multi_Tabs_3 if(Marker==6) cout<<Markered_Symbol; else cout<<" "; printf(" Press   6  :   to Enter                     SUDOKU ERA\n\n");

    Multi_Tabs_3 if(Marker==7) cout<<Markered_Symbol; else cout<<" "; printf(" Press   7  :   to Enter                    CRICKET ERA\n");
    Multi_Tabs_3 if(Marker==8) cout<<Markered_Symbol; else cout<<" "; printf(" Press   8  :   to Enter                 Mini GAMES ERA\n\n");

    //    Multi_Tabs_3                                           cout<<" "; printf(" Press (' \" ] } ),       to Change Text & BG Colour\n");                //Instruction end
    Multi_Tabs_3                                           cout<<" "; printf(" Press   ?  :   to See                MORE INSTRUCTIONS\n");
    Multi_Tabs_3                                           cout<<" "; printf(" Press   *  :   to See                             DEMO\n\n");

    Multi_Tabs_3                                           cout<<" "; printf(" Press ENTER :  to Enter                the MARKED GAME\n");
    Multi_Tabs_3                                           cout<<" "; printf(" Press  END  :  to CLOSE                    THE PROGRAM\n\n");
            ...
            while(true)
            {
                ...
                if (kbhit())           //Control by arrow KEY
                {
                    ...
                    if(Ludo_Marker == 9)
                    {
                        ...
                        cout<<"Snakes  : 97 --> 12, 63 -->  3, 70 --> 25, 32 --> 13, 60 --> 38, 73 --> 47, 82 --> 43 \n";
                        cout<<"Ladders : 6  --> 16,  8 --> 41, 26 --> 29, 50 --> 93, 55 --> 80, 59 --> 84, 66 --> 88 \n\n";
...
//                            cout << "Player-" << i << " : " << Board[i] << "(+" << Dice << ")" << "\t"; //Print
        ...
        case 6: //Sudoku (Fixed Given Value)
        {
            ...
            while(true)
            {
                ...
                Multi_Tabs_2 cout << "Select Difficulty Level :\n\n";
                Multi_Tabs_3 cout << "Press --> 1   :   Very Easy\n";
                Multi_Tabs_3 cout << "Press --> 2   :   Easy\n";
                Multi_Tabs_3 cout << "Press --> 3   :   Medium\n";
                Multi_Tabs_3 cout << "Press --> 4   :   Hard\n";
                Multi_Tabs_3 cout << "Press --> 5   :   Very Hard\n";
                Multi_Tabs_3 cout << "Press --> 6   :   Expert\n\n";
                Multi_Tabs_3 cout << "Press --> HOME / END / X  :  Back to Menu\n\n";
                ...
                while(true)
                {
                    ...
                    Multi_Tabs_3 cout << ". Indicates                                      Blank Index\n";
